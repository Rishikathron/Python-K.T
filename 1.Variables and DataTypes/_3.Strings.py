...
#syntax for slicing str_varname[starting_index : endingIndex-1] excluding the ending index
print(word[2:5])
...
print("Reversing the index "+rev_index[-5:-2])
...
split_var = "Hai, python, hello, bye"   #split returns ['hai', 'python','hello','bye']       
...
#ex-0
age = 23
txt = "My name is Sriram, I am from" 
